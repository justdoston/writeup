...
This machines vunerable to CVE-2024-39205 bypassing sandbox using RCE we will get app user shell then from sql database we can crack password hash of another user and finally manipulating .conf file of backup tool we can get root user. More about author: offsec1337.com
